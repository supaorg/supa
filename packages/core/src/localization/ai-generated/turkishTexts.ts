...
export const turkishTexts: Partial<Texts> = {
  ...
  appPage: {
    ...
    contactMessage: "Diğer uygulama türlerini oluşturma özelliği yakında gelecek. Uygulama için fikir veya önerileriniz varsa <a class=\"anchor\" href=\"mailto:d@dkury.com\">d@dkury.com</a> adresine yazın."
  },
  ...
  appConfigPage: {
    ...
    description: "Varsayılan sohbet uygulamasına dayalı kendi sistem komutlarınızı (talimatlar) oluşturabilirsiniz. t69'ın gelecek sürümlerinde araçlar ve harici API'lerle başka tür uygulamalar oluşturmak mümkün olacak."
  },
