...
export const hindiTexts: Texts = {
  ...
  appPage: {
    ...
    chatsTitle: "चैट",
    contactMessage: "अन्य प्रकार के एप्लिकेशन बनाने की क्षमता जल्द ही आ रही है। यदि आपके पास एप्लिकेशन के लिए विचार या सुझाव हैं, तो <a class=\"anchor\" href=\"mailto:hi@supa.cloud\">hi@supa.cloud</a> पर लिखें।"
  },
  ...
  appConfigPage: {
    ...
    description: "आप डिफ़ॉल्ट चैट एप्लिकेशन के आधार पर अपने खुद के सिस्टम प्रॉम्प्ट (निर्देश) बना सकते हैं। Supamind के भविष्य के संस्करणों में टूल्स और बाहरी API के साथ अन्य प्रकार के एप्लिकेशन बनाना संभव होगा।"
  },
