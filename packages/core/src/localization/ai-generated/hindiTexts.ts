...
export const hindiTexts: Partial<Texts> = {
  ...
  appConfigPage: {
    ...
    description: "आप डिफ़ॉल्ट चैट एप्लिकेशन के आधार पर अपने खुद के सिस्टम प्रॉम्प्ट (निर्देश) बना सकते हैं। Supa के भविष्य के संस्करणों में टूल्स और बाहरी API के साथ अन्य प्रकार के एप्लिकेशन बनाना संभव होगा।"
  },
