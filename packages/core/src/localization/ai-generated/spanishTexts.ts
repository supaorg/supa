...
export const spanishTexts: Texts = {
  basics: {
    supa: "Supa",
    name: "Nombre",
    button: "Botón",
  ...
  appPage: {
    ...
    chatsTitle: "Chats",
    contactMessage: "La capacidad de crear otros tipos de aplicaciones llegará pronto. Escribe a <a class=\"anchor\" href=\"mailto:hi@supa.cloud\">hi@supa.cloud</a> si tienes ideas o sugerencias para una aplicación."
  },
  ...
  appConfigPage: {
    ...
    description: "Puedes crear tus propios prompts de sistema (instrucciones) basados en la aplicación de chat predeterminada. Será posible crear otros tipos de aplicaciones con herramientas y APIs externas en futuras versiones de Supamind."
  },
