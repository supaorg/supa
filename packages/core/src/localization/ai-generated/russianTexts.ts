...
export const russianTexts: Partial<Texts> = {
  ...
  appConfigPage: {
    ...
    description: "Вы можете создавать свои собственные системные промпты (инструкции) на основе чата по умолчанию. В будущих версиях Sila будет возможно создавать другие типы приложений с инструментами и внешними API."
  },
