...
export const russianTexts: Partial<Texts> = {
  ...
  appPage: {
    ...
    chatsTitle: "Чаты",
    contactMessage: "Возможность создавать другие типы приложений появится позже. Напишите на <a class=\"anchor\" href=\"mailto:d@dkury.com\">d@dkury.com</a>, если у вас есть идеи или предложения для приложения."
  },
  ...
  appConfigPage: {
    ...
    description: "Вы можете создавать свои собственные системные промпты (инструкции) на основе чата по умолчанию. В будущих версиях Supa будет возможно создавать другие типы приложений с инструментами и внешними API."
  },
