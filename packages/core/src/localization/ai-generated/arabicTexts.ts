...
export const arabicTexts: Partial<Texts> = {
  ...
  appConfigPage: {
    ...
    description: "يمكنك إنشاء موجهات النظام الخاصة بك (التعليمات) بناءً على تطبيق الدردشة الافتراضي. سيكون من الممكن إنشاء أنواع أخرى من التطبيقات باستخدام الأدوات وواجهات برمجة التطبيقات الخارجية في الإصدارات المستقبلية من Supa."
  },
