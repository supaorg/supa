...
export const arabicTexts: Partial<Texts> = {
  ...
  appPage: {
    ...
    chatsTitle: "الدردشات",
    contactMessage: "ستتوفر قريباً القدرة على إنشاء أنواع أخرى من التطبيقات. اكتب إلى <a class=\"anchor\" href=\"mailto:hi@supa.cloud\">hi@supa.cloud</a> إذا كان لديك أفكار أو اقتراحات لتطبيق."
  },
  ...
  appConfigPage: {
    ...
    description: "يمكنك إنشاء موجهات النظام الخاصة بك (التعليمات) بناءً على تطبيق الدردشة الافتراضي. سيكون من الممكن إنشاء أنواع أخرى من التطبيقات باستخدام الأدوات وواجهات برمجة التطبيقات الخارجية في الإصدارات المستقبلية من Supamind."
  },
