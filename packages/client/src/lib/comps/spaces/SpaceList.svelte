<script lang="ts">
  ...
  import SpaceOptionsPopup from "@client/comps/popups/SpaceOptionsPopup.svelte";
  import RenamingPopup from "@client/comps/popups/RenamingPopup.svelte";
  import type { SpacePointer } from "@client/spaces/SpacePointer";
