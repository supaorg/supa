...
export const japaneseTexts: Texts = {
  basics: {
    supa: "Supa",
    name: "名前",
    button: "ボタン",
  ...
  appPage: {
    ...
    chatsTitle: "チャット",
    contactMessage: "他のタイプのアプリを作成する機能は近日公開予定です。アプリについてのアイデアや提案がありましたら、<a class=\"anchor\" href=\"mailto:hi@supa.cloud\">hi@supa.cloud</a>までご連絡ください。"
  },
  ...
  appConfigPage: {
    ...
    description: "デフォルトチャットアプリをベースに、独自のシステムプロンプト（指示）を作成できます。Supamindの将来のバージョンでは、ツールや外部APIを使用して他のタイプのアプリを作成することが可能になります。"
  },
